object MainForm: TMainForm
  ...
  object IndelBox: TGroupBox
    ...
    object InsertionDistBox: TRadioGroup
      Left = 11
      Top = 47
      Width = 102
      Height = 73
      ...
      Items.Strings = (
        ...
        'Power')
      TabOrder = 6
      OnClick = InsertionDistBoxClick
    end
    object DeletionDistBox: TRadioGroup
      Left = 11
      Top = 159
      Width = 102
      Height = 73
      ...
      Items.Strings = (
        ...
        'Power')
      TabOrder = 7
      OnClick = DeletionDistBoxClick
    end
    object InsertionExpBox: TLabeledEdit
      Left = 208
      Top = 92
      Width = 57
      Height = 21
      EditLabel.Width = 45
      EditLabel.Height = 13
      EditLabel.Caption = 'Exponent'
      Enabled = False
      TabOrder = 8
      Text = '-2'
    end
    object DeletionExpBox: TLabeledEdit
      Left = 207
      Top = 212
      Width = 57
      Height = 21
